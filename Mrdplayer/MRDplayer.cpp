...
{
    int seconds = static_cast<int>(mediaPlayer->duration()/1000);  //Time Conversion
...
void PlayerWindow::on_vSliderSound_valueChanged(int value)
{
    ...
    if(value == 0){
        ui->BtnMute->setIcon(QIcon(":/Resources/ui_icons/MuteBt.png"));
    }else{
        ui->BtnMute->setIcon(QIcon(":/Resources/ui_icons/VoiceBt.png"));
    }
...
void PlayerWindow::on_actionInfo_triggered()
{
    ...
    mssInfo.setText("This media player is developed by Dananjaya Bandara."
